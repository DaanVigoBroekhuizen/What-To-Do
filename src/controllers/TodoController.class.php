...
class ToDoController
{
    ...
    public function todoPLUS()
    {
        ...
        R::store($bean);
        R::exec("UPDATE todo SET volgorde = $volgorde WHERE volgorde = $volgordeplus AND id <> $id AND user_id = $userid");
        header("Location: ../../todo/todoIndex");
    }
    ...
    public function todoMIN()
    {
        ...
        R::store($bean);
        R::exec("UPDATE todo SET volgorde = $volgorde WHERE volgorde = $volgordemin AND id <> $id AND user_id = $userid");
        echo $id;
        echo $username;
        header("Location: ../../todo/todoIndex");
    }
